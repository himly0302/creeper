# Claude Code中文网 - AI编程助手完整教程

> 📅 **爬取时间**: 2025-11-28 14:12:35
> 🔗 **来源链接**: https://www.claude-cn.org/posts/Claude-code-best-practices.html
> 📝 **网页描述**: Claude Code中文教程网站，提供完整的安装指南、使用技巧、最佳实践和实战案例
> ✍️ **作者**: Claude 中文网
> 📆 **发布时间**: 2025-08-22
> 🎯 **爬取方式**: 静态爬取
...
![在这里插入图片描述](images/6d41cafc69df-1.png)
...
![在这里插入图片描述](images/07b10c27354e-1.png)
...
![在这里插入图片描述](images/003bf18074f7-1.png)
...
![在这里插入图片描述](images/c5efe6ef90d3-1.png)
...
![在这里插入图片描述](images/f5555e5328b2-1.png)
...
![在这里插入图片描述](images/3230e85e9a0a-1.png)

## c. 明确提及要处理的文件

用 tab 补全快速引用仓库中任意文件或文件夹，帮助 Claude 找到或更新正确资源。

![在这里插入图片描述](images/583dee8db160-1.png)
